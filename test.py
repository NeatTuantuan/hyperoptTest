...
def changeConfig(configs):
    ...
    configString = ""
    configString += ("\n" + paramNames[0] + " " + str(configList[0].split(".")[0]))
    configString += ("\n" + paramNames[1] + " " + str(configList[1].split(".")[0]))
    configString += ("\n" + paramNames[2] + " " + str(configList[2].split(".")[0]))
    configString += ("\n" + paramNames[3] + " " + str(configList[3].split(".")[0]))
    configString += ("\n" + paramNames[4] + " " + str(configList[4].split(".")[0]))
